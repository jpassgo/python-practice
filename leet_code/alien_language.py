...
# before the letter in t in the alien language. If the first min(s.length, t.length) letters are the same, then s is smaller if and only if s.length < t.length.
# 
...
# My plan for this is to create a trie, and then traverse the trie using bfs, adding 
